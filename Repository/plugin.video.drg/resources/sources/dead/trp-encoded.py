...
def get_links(tv_movie,original_title,season_n,episode_n,season,episode,show_original_year,id):
    ...
    if 1:
        ...
        x=requests.get('https://theaterplus.xyz/api2/get_search_results/?api_key=new11uT8cBLzm6a1YvsiUWOEgrFowk95K2DM3tHAPRCX4ypGjN&search='+(search_url),headers=headers,timeout=10,verify=False).content
