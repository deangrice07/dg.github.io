...
def get_links(tv_movie,original_title,season_n,episode_n,season,episode,show_original_year,id):
    ...
    response = requests.get('https://gowatchseries.tv/search.html?keyword='+search_string, headers=base_header).content
    ...
    for itt in m_pre:
        ...
        for lk,nm in m:
            ...
            if check:
                x=requests.get('https://gowatchseries.tv'+lk, headers=base_header).content
                ...
                y=requests.get('https://gowatchseries.tv'+m2, headers=base_header).content
                regex='data-video="(.+?)"'
