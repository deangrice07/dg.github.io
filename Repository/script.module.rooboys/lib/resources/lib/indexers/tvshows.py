...
class tvshows:
    def __init__(self):
        ...
        self.fiftyst_link = 'https://www.imdb.com/search/title?title_type=tv_series&release_date=1950-01-01,1959-12-31&user_rating=5.0,10.0'
        self.sixtyst_link = 'https://www.imdb.com/search/title?title_type=tv_series&release_date=1960-01-01,1969-12-31&user_rating=5.0,10.0'
        self.seventyst_link = 'https://www.imdb.com/search/title?title_type=tv_series&release_date=1970-01-01,1979-12-31&user_rating=5.0,10.0'
        self.eightyst_link = 'https://www.imdb.com/search/title?title_type=tv_series&release_date=1980-01-01,1989-12-31&user_rating=5.0,10.0'
        self.ninetyst_link = 'https://www.imdb.com/search/title?title_type=tv_series&release_date=1990-01-01,1999-12-31&user_rating=5.0,10.0'
        self.twothousandt00_link = 'https://www.imdb.com/search/title?title_type=tv_series&release_date=2000-01-01,2009-12-31&user_rating=5.0,10.0'
        self.twothousandt10_link = 'https://www.imdb.com/search/title?title_type=tv_series&release_date=2010-01-01,2019-12-31&user_rating=5.0,10.0,'
