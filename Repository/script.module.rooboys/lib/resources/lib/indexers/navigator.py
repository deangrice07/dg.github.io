...
class navigator:
    ...
    NEWSFILE      = base64.b64decode(b'aHR0cDovL3JlcG8ucnVieWpld2Vsd2l6YXJkLmNvbS9NeV9PdGhlcl9TdHVmZi93aGF0c25ldy54bWw=')
    LOCALNEWS     = os.path.join(THISADDONPATH, 'whatsnew.txt')
    
    def root(self):
        self.addDirectoryItem('[B][COLORroyalblue]W[/COLOR][/B][B][COLORwhite]E[/COLOR][/B][B][COLORroyalblue]L[/COLOR][/B][B][COLORwhite]C[/COLOR][/B][B][COLORroyalblue]O[/COLOR][/B][B][COLORwhite]M[/COLOR][/B][B][COLORroyalblue]E[/COLOR][/B] [B][COLORwhite]T[/COLOR][/B][B][COLORroyalblue]O[/COLOR][/B] [B][COLORwhite]T[/COLOR][/B][B][COLORroyalblue]H[/COLOR][/B][B][COLORwhite]E[/COLOR][/B] [B][COLORroyalblue]R[/COLOR][/B][B][COLORwhite]O[/COLOR][/B][B][COLORroyalblue]O[/COLOR][/B][B][COLORwhite]B[/COLOR][/B][B][COLORroyalblue]O[/COLOR][/B][B][COLORwhite]Y[/COLOR][/B][B][COLORroyalblue]S[/COLOR][/B] [B][COLORwhite]A[/COLOR][/B][B][COLORroyalblue]D[/COLOR][/B][B][COLORwhite]D[/COLOR][/B][B][COLORroyalblue]O[/COLOR][/B][B][COLORwhite]N[/COLOR][/B]', 'newsNavigator', 'icon.gif', 'DefaultAddonProgram.png')
        if self.getMenuEnabled('navi.monthlyclown') == True:
            self.addDirectoryItem('[B][COLORroyalblue]R[/COLOR][/B][B][COLORwhite]o[/COLOR][/B][B][COLORroyalblue]o[/COLOR][/B][B][COLORwhite]b[/COLOR][/B][B][COLORroyalblue]o[/COLOR][/B][B][COLORwhite]y[/COLOR][/B][B][COLORroyalblue]s[/COLOR][/B] Hot Movie List', 'movies&url=clowns', 'featured.png', 'DefaultRecentlyAddedMovies.png')
        
##        if self.getMenuEnabled('navi.clownspecial') == True:
##           self.addDirectoryItem('[B][COLOR orange]MTB Specials (1 CLICKS, IPTV, MAIN EVENTS)[/COLOR][/B]', 'lists', 'tvshows.png', 'DefaultTVShows.png')
        
##        if self.getMenuEnabled('navi.monthlyspotlight') == True:
##            self.addDirectoryItem('[B][COLOR yellow]Spotlight Movies 1930 to 1959[/COLOR][/B]', 'movies&url=spotlight', 'spotlight.png', 'DefaultRecentlyAddedMovies.png')
 
        self.addDirectoryItem(32001, 'movieNavigator', 'movies.png', 'DefaultMovies.png')
        if not control.setting('movie.widget') == '0':
            self.addDirectoryItem(32005, 'movieWidget', 'latest-movies.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(40003, 'collections3Navigator', 'years.png', 'DefaultMovies.png')		
        ...
        self.addDirectoryItem(40005, 'collections5Navigator', 'tvyears.png', 'DefaultMovies.png')	
        ...
        self.addDirectoryItem('Scraper Settings', 'openscrapersSettings&query=0.0', 'scrapers.png', 'DefaultAddonProgram.png')
		
        self.addDirectoryItem('[COLOR=orange]Begin Extended Categories[/COLOR]', 'nonewsNavigator', 'userlists.png', 'DefaultAddonProgram.png')

        if self.getMenuEnabled('navi.moviesyt') == True:
            self.addDirectoryItem(80004, 'moviesyt', 'movietime.jpg', 'DefaultMovies.png')
...
#######################################################################
    ...
    def movies(self, lite=False):
        ...
        if self.getMenuEnabled('navi.movielanguages') == True:
            ...
            self.addDirectoryItem(40000, 'collections2Navigator', 'certificates.png', 'DefaultMovies.png')			
        ...
        if self.getMenuEnabled('navi.movierazzie') == True:
            self.addDirectoryItem(40004, 'movies&url=razzie', 'oscar-winners.png', 'DefaultMovies.png')
    ...
    def collections2(self, lite=False):
        if self.getMenuEnabled('navi.ratedg') == True:
            self.addDirectoryItem('Movies Rated G', 'movies&url=ratedg', 'certificates.png', 'DefaultRecentlyAddedMovies.png')
        if self.getMenuEnabled('navi.ratedpg13') == True:
            self.addDirectoryItem('Movies Rated PG-13', 'movies&url=ratedpg13', 'certificates.png', 'DefaultRecentlyAddedMovies.png')
        if self.getMenuEnabled('navi.ratedpg') == True:
            self.addDirectoryItem('Movies Rated PG', 'movies&url=ratedpg', 'certificates.png', 'DefaultRecentlyAddedMovies.png')
        if self.getMenuEnabled('navi.ratedr') == True:
            self.addDirectoryItem('Movies Rated R', 'movies&url=ratedr', 'certificates.png', 'DefaultRecentlyAddedMovies.png')
        if self.getMenuEnabled('navi.ratednc17') == True:
            self.addDirectoryItem('Movies Rated NC-17', 'movies&url=ratednc17', 'certificates.png', 'DefaultRecentlyAddedMovies.png')
			
        self.endDirectory()

		
    def collections3(self, lite=False):
        if self.getMenuEnabled('navi.thrtys') == True:
            self.addDirectoryItem('30s Movies 1930 - 1939', 'movies&url=thrtys', 'years.png', 'DefaultMovies.png')
        if self.getMenuEnabled('navi.fortys') == True:
            self.addDirectoryItem('40s Movies 1940 - 1949', 'movies&url=fortys', 'years.png', 'DefaultMovies.png')
        ...
        if self.getMenuEnabled('navi.twothousand00') == True:
            self.addDirectoryItem('2K-00s Movies 2000 - 2009', 'movies&url=twothousand00', 'years.png', 'DefaultMovies.png')
        if self.getMenuEnabled('navi.twothousand10') == True:
            self.addDirectoryItem('2K-10s Movies 2010 - 2019', 'movies&url=twothousand10', 'years.png', 'DefaultMovies.png')			
			
        self.endDirectory()

		
    def collections5(self, lite=False):
        ...
        if self.getMenuEnabled('navi.twothousands00') == True:
            self.addDirectoryItem('2K-00s TV Shows 2000 - 2009', 'tvshows&url=twothousandt00', 'years.png', 'DefaultTVShows.png')
        if self.getMenuEnabled('navi.twothousands10') == True:
            self.addDirectoryItem('2K-10s TV Shows 2010 - 2019', 'tvshows&url=twothousandt10', 'years.png', 'DefaultTVShows.png')
