...
class navigator:
    ...
    def root(self):
        self.addDirectoryItem(32636, 'newsNavigator', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem(32001, 'movieNavigator', 'movies.png', 'DefaultMovies.png')
        if self.getMenuEnabled('navi.movietheaters') == True:
            self.addDirectoryItem(320222, 'tmdb&url=theaters', 'movies.png', 'DefaultRecentlyAddedMovies.png')
        if self.getMenuEnabled('navi.tmdb') ==True:
            self.addDirectoryItem(32634, 'tmdbNavigator', 'tmdb2.png', 'DefaultMovies.png')
        ...
        self.addDirectoryItem(32631, 'mytraktNavigator', 'trakt.png', 'DefaultTVShows.png')
        if self.getMenuEnabled('navi.docu') == True:
            self.addDirectoryItem(32630, 'docuNavigator', 'channels.png', 'DefaultMovies.png')
        ...
        if self.getMenuEnabled('navi.radio') is True:
            self.addDirectoryItem('Radio', 'radioNavigator', 'podcast.png', 'DefaultVideoPlaylists.png')
...
#######################################################################
    ...
    def mytrakt(self):      
        ...
        self.addDirectoryItem(32637, 'movies&url=trakthistory', 'trakt.png', 'DefaultMovies.png', queue=True)
        self.addDirectoryItem(32638, 'calendar&url=trakthistory', 'trakt.png', 'DefaultTVShows.png', queue=True)
        self.addDirectoryItem(32639, 'movies&url=traktwatchlist', 'trakt.png', 'DefaultMovies.png', queue=True, context=(32551, 'moviesToLibrary&url=traktwatchlist'))
        self.addDirectoryItem(32640, 'tvshows&url=traktwatchlist', 'trakt.png', 'DefaultTVShows.png', context=(32551, 'tvshowsToLibrary&url=traktwatchlist'))
    ...
    def tmdb(self):
        self.addDirectoryItem('[COLOR=green].TMDb Selection[/COLOR]','tmdb', 'loop.gif', 'DefaultVideoPlaylists.png')
	self.addDirectoryItem(32632, 'collections&url=movielaplaza', 'tmdb2.png', 'DefaultVideoPlaylists.png')
	self.addDirectoryItem(32633, 'collections&url=kidsboxcollection2', 'tmdb2.png', 'DefaultVideoPlaylists.png')
        self.addDirectoryItem(32641, 'collections&url=marvelmovies', 'tmdb2.png', 'DefaultVideoPlaylists.png')
        self.addDirectoryItem('[COLOR=orange].TMDb Collection[/COLOR]','tmdb', 'icon.png', 'DefaultVideoPlaylists.png')
        self.addDirectoryItem(32635,  'boxsetsNavigator', 'tmdb2.png', 'DefaultMovies.png')
	self.addDirectoryItem(32092, 'holidaysNavigator', 'tmdb2.png', 'DefaultMovies.png')
	self.addDirectoryItem(32093, 'collections&url=netflixmovies', 'tmdb2.png', 'DefaultMovies.png')
	self.addDirectoryItem(32094, 'collections&url=disneymovies2', 'tmdb2.png', 'DefaultMovies.png')
        self.addDirectoryItem(32091, 'actorNavigator', 'tmdb2.png', 'DefaultMovies.png')			
        self.endDirectory()
    ...
    def iptv(self):
	    ...
	    self.addDirectoryItem('RadioTV', 'radiotv', 'networks.png', '')
            self.addDirectoryItem('SportPlugins', 'sportplugins', 'networks.png', 'fanart.jpg')
