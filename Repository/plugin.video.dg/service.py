...
def syncTraktLibrary():
    control.execute(
        'RunPlugin(plugin://%s)' % 'plugin.video.dg/?action=tvshowsToLibrarySilent&url=traktcollection')
    control.execute(
        'RunPlugin(plugin://%s)' % 'plugin.video.dg/?action=moviesToLibrarySilent&url=traktcollection')
...
#    log_utils.log('### DG REPOSITORY VERSION: %s ###' % str(RepoVersion), log_utils.LOGNOTICE)
    ...
    log_utils.log('######################### DG ############################', log_utils.LOGNOTICE)
    log_utils.log('####### CURRENT DG VERSIONS REPORT ######################', log_utils.LOGNOTICE)
    log_utils.log('### ERROR GETTING DG VERSIONS - NO HELP WILL BE GIVEN AS THIS IS NOT AN OFFICIAL DG INSTALL. ###', log_utils.LOGNOTICE)
    log_utils.log('###############################################################', log_utils.LOGNOTICE)
