...
class tvshows:
    def __init__(self):
        ...
        self.year_link = 'https://www.imdb.com/search/title?title_type=tv_series&year=%s,%s&sort=moviemeter,asc&count=40&start=1'
        ...
        self.twothousandt_link = 'https://www.imdb.com/search/title?title_type=tv_series&release_date=2000-01-01,2009-12-31&user_rating=5.0,'
        self.twothousandt2_link = 'https://www.imdb.com/search/title?title_type=tv_series&release_date=2010-01-01,2019-12-31&user_rating=5.0,'
