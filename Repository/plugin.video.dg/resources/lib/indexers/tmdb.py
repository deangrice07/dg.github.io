...
class movies:
    def __init__(self):
        ...
        if self.tmdb_key == '' or self.tmdb_key == None:
            self.tmdb_key = base64.b64decode('MDQyZjRjNzAwNzM5Y2MwMjIwNDllYmZhNzcwZDcxODk=')
...
# tmdb.movies().actorBoxset()
    ...
    def mysupermv(self, lite=False):
        self.addDirectoryItem('DC Movies', 'collections&url=tmdbdcmovies', 'tmdb2.png', 'DefaultVideoPlaylists.png')
        self.addDirectoryItem('DC Animated Movies', 'collections&url=tmdbdcanimovies', 'tmdb2.png', 'DefaultVideoPlaylists.png')
        self.addDirectoryItem('The DC Movies', 'collections&url=tmdbdc', 'tmdb2.png', 'DefaultVideoPlaylists.png')
        self.addDirectoryItem('DC Comics Collection', 'collections&url=dcmovies', 'tmdb2.png', 'DefaultVideoPlaylists.png')
        self.addDirectoryItem('Marvel Movies', 'collections&url=tmdbmarvelmovies', 'tmdb2.png', 'DefaultVideoPlaylists.png')
        self.addDirectoryItem('Marvel Animated Movies', 'collections&url=tmdbmarvelanimovies', 'tmdb2.png', 'DefaultVideoPlaylists.png')
        self.addDirectoryItem('The Marvel Movies', 'collections&url=tmdbmarvel', 'tmdb2.png', 'DefaultVideoPlaylists.png')
        self.addDirectoryItem('Marvel Collection', 'collections&url=marvelmovies', 'tmdb2.png', 'DefaultVideoPlaylists.png')
        self.addDirectoryItem('Super Heroes', 'collections&url=tmdbhero', 'tmdb2.png', 'DefaultVideoPlaylists.png')
        self.addDirectoryItem('Superhero Collections', 'collectionSuperhero', 'tmdb2.png', 'DefaultVideoPlaylists.png')
        self.endDirectory()

    def collectionSuperhero(self):
        self.addDirectoryItem('Avengers', 'collections&url=avengers', 'tmdb.png', 'DefaultVideoPlaylists.png')
        self.addDirectoryItem('Batman', 'collections&url=batman', 'tmdb.png', 'DefaultVideoPlaylists.png')
        self.addDirectoryItem('Captain America', 'collections&url=captainamerica', 'tmdb.png', 'DefaultVideoPlaylists.png')
        self.addDirectoryItem('Dark Knight Trilogy', 'collections&url=darkknight', 'tmdb.png', 'DefaultVideoPlaylists.png')
        self.addDirectoryItem('Fantastic Four', 'collections&url=fantasticfour', 'tmdb.png', 'DefaultVideoPlaylists.png')
        self.addDirectoryItem('G.I. Joe', 'collections&url=tmdbgi', 'tmdb.png', 'DefaultVideoPlaylists.png')
        self.addDirectoryItem('Hulk', 'collections&url=hulk', 'tmdb.png', 'DefaultVideoPlaylists.png')
        self.addDirectoryItem('Iron Man', 'collections&url=ironman', 'tmdb.png', 'DefaultVideoPlaylists.png')
        self.addDirectoryItem('Spider-Man', 'collections&url=spiderman', 'tmdb.png', 'DefaultVideoPlaylists.png')
        self.addDirectoryItem('Superman', 'collections&url=superman', 'tmdb.png', 'DefaultVideoPlaylists.png')
        self.addDirectoryItem('X-Men', 'collections&url=xmen', 'tmdb.png', 'DefaultVideoPlaylists.png')
        self.endDirectory()


    def kidsboxsets(self, lite=False):
        self.addDirectoryItem('3 Ninjas (1992-1998)', 'collections&url=ninja', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' 101 Dalmations (1968-2003)', 'collections&url=onehundredonedalmations', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' A Goofy Movie (1995-2000)', 'collections&url=goofy', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Aladdin (1992-1996)', 'collections&url=aladdin', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Alvin and the Chipmunks (1987-2015)', 'collections&url=alvin', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Angry Birds (2016-2019)', 'collections&url=birds', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Atlantis (2001-2003)', 'collections&url=atlantis', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Babe (1995-1998)', 'collections&url=babe', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Back to the Future (1985-1990)', 'collections&url=future', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Beauty and the Beast (1991-2017)', 'collections&url=beautyandthebeast', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Beethoven (1992-2014)', 'collections&url=beethoven', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Brother Bear (2003-2006)', 'collections&url=bear', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Cars (2006-2017)', 'collections&url=cars', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Chronicles of Narnia (2005-2010)', 'collections&url=narnia', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Cinderella (1950-2007)', 'collections&url=cinderella', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Cloudy with a Chance of Meatballs (2009-2013)', 'collections&url=cloudy', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Despicable Me (2010-2017)', 'collections&url=despicable', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Diary of a Wimpy Kid (2010-2017)', 'collections&url=wimpy', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Emperors New Groove (2000-2005)', 'collections&url=emperor', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Fantastic Beasts (2016-2018)', 'collections&url=beasts', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Finding Nemo (2003-2016)', 'collections&url=nemo', 'kids_boxsets.png', 'DefaultMovies.png')
        self.addDirectoryItem(' Fox and the Hound (1981-2006)', 'collections&url=foxandthehound', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Free Willy (1993-2010)', 'collections&url=freewilly', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Frozen (2013-2019)', 'collections&url=frozen', 'kids_boxsets.png', 'DefaultMovies.png')
        self.addDirectoryItem(' Ghostbusters (1984-2016)', 'collections&url=ghostbusters', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Gremlins (1984-1990)', 'collections&url=gremlins', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' G.I. Joe (2009-2013)', 'collections&url=gijoe', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Gnomeo & Juliet (2011-2018)', 'collections&url=gnomes', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Goosebumps (2015-2018)', 'collections&url=goosebumps', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Happy Feet (2006-2011)', 'collections&url=feet', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Harry Potter (2001-2009)', 'collections&url=harry', 'kids_boxsets.png', 'DefaultMovies.png')
        self.addDirectoryItem(' Home Alone (1990-2012)', 'collections&url=homealone', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Honey, I Shrunk the Kids (1989-1997)', 'collections&url=shrunk', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Hoodwinked (2005-2011)', 'collections&url=hoodwinked', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Hotel Transylvania (2012-2018)', 'collections&url=transylvania', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' How to Train Your Dragon (2010-2019)', 'collections&url=dragon', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Hunchback of Notre Dame (1996-2002)', 'collections&url=hunchbackofnotredame', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Ice Age (2002-2016)', 'collections&url=ice', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Jurassic Park (1993-2018)', 'collections&url=jurassic', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Kung Fu Panda (2008-2016)', 'collections&url=panda', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Lady and the Tramp (1955-2001)', 'collections&url=lady', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Lilo & Stitch (2002-2005)', 'collections&url=lilo', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Madagascar (2005-2014)', 'collections&url=mad', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Men in Black (1997-2019)', 'collections&url=mib', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Minions (2015-2020)', 'collections&url=minions', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Monsters, inc. (2001-2013)', 'collections&url=monsters', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Mulan (1998-2004)', 'collections&url=mulan', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Nanny McPhee (2005-2010)', 'collections&url=nanny', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Narnia (2005-2010)', 'collections&url=narnia', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' New Groove (2000-2005)', 'collections&url=newgroove', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Night at the Museum (2006-2014)', 'collections&url=museum', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Nut Job (2014-2017)', 'collections&url=nut', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Open Season (2006-2015)', 'collections&url=open', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Paddington Bear (2014-2017)', 'collections&url=padd', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Percy Jackson (2010-2013)', 'collections&url=percy', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Pirates of the Caribbean (2003-2017)', 'collections&url=pirates', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Planes (2013-2014)', 'collections&url=planes', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Pocahontas (1995-1998)', 'collections&url=pocahontas', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Pokémon (1998-2019)', 'collections&url=pokemon', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Problem Child (1990-1995)', 'collections&url=problemchild', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Rio (2011-2014)', 'collections&url=rio', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Sammys Adventures (2010-2012)', 'collections&url=sammysadventures', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Scooby-Doo (2002-2014)', 'collections&url=scoobydoo', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Short Circuit (1986-1988)', 'collections&url=shortcircuit', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png') 
        self.addDirectoryItem(' Shaun the Sheep (2015-2019)', 'collections&url=sheep', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Shrek (2001-2010)', 'collections&url=shrek', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Smurfs (2011-2017)', 'collections&url=smurf', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' SpongeBob SquarePants (2004-2017)', 'collections&url=spongebobsquarepants', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Spy Kids (2001-2011)', 'collections&url=spykids', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Star Wars (1977-2018)', 'collections&url=starwars', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Stuart Little (1999-2002)', 'collections&url=stuartlittle', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Surfs Up (2007-2017)', 'collections&url=surf', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Tarzan (1999-2002)', 'collections&url=tarzan', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Tinker Bell (2007-2020)', 'collections&url=tinker', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' The Addams Family (1991-1993)', 'collections&url=addams', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' The Flintstones (1994-2000)', 'collections&url=flint', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' The Incredibles (2004-2018)', 'collections&url=incredibles', 'kids_boxsets.png', 'DefaultMovies.png')
        self.addDirectoryItem(' The Jungle Book (1967-2003)', 'collections&url=thejunglebook', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' The Karate Kid (1984-2010)', 'collections&url=thekaratekid', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' The Land Before Time (1988-2007)', 'collections&url=land', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' The Lion King (1994-2019)', 'collections&url=king', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' The Little Mermaid (1989-1995)', 'collections&url=thelittlemermaid', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' The Mighty Ducks (1992-1996)', 'collections&url=ducks', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' The Mummy (1999-2017)', 'collections&url=mummy', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' The Neverending Story (1984-1994)', 'collections&url=theneverendingstory', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' The Secret Life of Pets (2016-2019)', 'collections&url=pets', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' The Smurfs (2011-2013)', 'collections&url=thesmurfs', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Tooth Fairy (2010-2012)', 'collections&url=toothfairy', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' TMNT (1978-2019)', 'collections&url=tmnt', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Tom and Jerry (1992-2013)', 'collections&url=tomandjerry', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Toy Story (1995-2019)', 'collections&url=toystory', 'kids_boxsets.png', 'DefaultMovies.png')
        self.addDirectoryItem(' Transformers (1986-2017)', 'collections&url&url=transformers', 'kids_boxsets.png', 'DefaultMovies.png')
        self.addDirectoryItem(' VeggieTales (2002-2008)', 'collections&url=veggietales', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Winnie the Pooh (2000-2005)', 'collections&url=winniethepooh', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Wizard of Oz (1939-2013)', 'collections&url=wizardofoz', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(' Wreck it Ralph (2012-2018)', 'collections&url=ralph', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
