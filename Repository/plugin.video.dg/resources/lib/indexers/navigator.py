...
class navigator:
    ...
    def movies(self, lite=False):
        ...
        self.addDirectoryItem('DG Favorite Movies', 'movies&url=https://api.trakt.tv/users/1coolguy/lists/apex-fav/items', 'icon.png', 'icon.png')
        self.addDirectoryItem('Steven King Movie Collection', 'movies&url=https://api.trakt.tv/users/1coolguy/lists/steven-king/items', 'stevenking.png', 'stevenking.png')
        self.addDirectoryItem('Horror Movies', 'movies&url=https://api.trakt.tv/users/1coolguy/lists/horror-movies/items', 'horror.png', 'horror.png')
        self.addDirectoryItem(32005, 'movieWidget', 'latest-movies.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(32022, 'movies&url=theaters', 'in-theaters.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('Marvel Movies', 'movies&url=https://api.trakt.tv/users/1coolguy/lists/marvel-movies/items', 'marvel tv shows.png', 'marvel tv shows.png')
        self.addDirectoryItem('DC Movies', 'movies&url=https://api.trakt.tv/users/1coolguy/lists/dc-movies/items', 'dc tv shows.png', 'dc tv shows.png')
        self.addDirectoryItem('Comedy Movies', 'movies&url=https://api.trakt.tv/users/ljransom/lists/comedy-movies/items', 'comedy.png', 'comedy.png')
        self.addDirectoryItem('Action Movies', 'movies&url=https://api.trakt.tv/users/ljransom/lists/action-shooter-movies/items', 'action.png', 'action.png')
        self.addDirectoryItem('War Movies', 'movies&url=https://api.trakt.tv/users/ljransom/lists/war-movies/items', 'war.png', 'war.png')
        self.addDirectoryItem('Crime Movies', 'movies&url=https://api.trakt.tv/users/ljransom/lists/crime-movies/items', 'crime.png', 'crime.png')
        self.addDirectoryItem('Based On A True Story', 'movies&url=true', 'true.png', 'playlist.jpg')
        self.addDirectoryItem('James Bond Collection', 'movies&url=bond', 'bond.png', 'playlist.jpg')
    ...
    def xmls(self):
        self.addDirectoryItem('1-Click New Release', 'extinfo', 'icon.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Horror 1-Click Movies', 'lists4', 'icon.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Kids 1-Click Movies', 'lists3', 'icon.png', 'DefaultTVShows.png')
        self.addDirectoryItem('4K Movies', 'lists2', 'icon.png', 'DefaultTVShows.png')
        self.addDirectoryItem('1-Click Tv-Shows', 'lists1', 'icon.png', 'DefaultTVShows.png')
        self.addDirectoryItem('1-Click Collections Set', 'lists5', 'icon.png', 'DefaultTVShows.png')
        self.addDirectoryItem('24/7 Kids TV', 'kids1', 'icon.png', 'mytvnavigator.png')
        self.addDirectoryItem('24/7 Horror', 'horror1', 'icon.png', 'mytvnavigator.png')
        self.addDirectoryItem('24/7 Docs', 'docs1', 'icon.png', 'mytvnavigator.png')
        self.addDirectoryItem('24/7 Action Movies', 'action1', 'icon.png', 'mytvnavigator.png')
        self.addDirectoryItem('24/7 Comedy Movies', 'comedy1', 'icon.png', 'mytvnavigator.png')
        self.addDirectoryItem('24/7 Drama', 'drama1', 'icon.png', 'mytvnavigator.png')
        self.addDirectoryItem('24/7 Romance', 'romance1', 'icon.png', 'mytvnavigator.png')
        self.addDirectoryItem('24/7 Crime Movies', 'crime1', 'icon.png', 'mytvnavigator.png')
        self.addDirectoryItem('24/7 Fantastic Zone', 'fantastic1', 'icon.png', 'mytvnavigator.png')
    ...
    def tvshows(self, lite=False):
        ...
        self.addDirectoryItem('Horror Tv Shows', 'tvshows&url=https://api.trakt.tv/users/1coolguy/lists/scaryshows/items', 'horrortv.png', 'horrortv.png')
        self.addDirectoryItem('DG Favorite Tv Shows', 'tvshows&url=https://api.trakt.tv/users/1coolguy/lists/my-tv-shows/items', 'icon.png', 'icon.png')
        self.addDirectoryItem('Marvel Tv', 'tvshows&url=https://api.trakt.tv/users/1coolguy/lists/marvel-tv-shows/items', 'marvel tv shows.png', 'marvel tv shows.png')
        self.addDirectoryItem('DC Tv', 'tvshows&url=https://api.trakt.tv/users/1coolguy/lists/dc-tv-shows/items', 'dc tv shows.png', 'dc tv shows.png')
        self.addDirectoryItem('Discovery Plus', 'tvshows&url=https://api.trakt.tv/users/richguy/lists/discovery/items', 'discovery.png', 'discovery.png')
        self.addDirectoryItem('Paramount Plus Tv ', 'tvshows&url=https://api.trakt.tv/users/sig1878/lists/tv-paramount-plus/items', 'Paramount.png', 'Paramount.png')
    ...
    def kids(self):
        self.addDirectoryItem('Anime Tv Shows', 'tvshows&url=https://api.trakt.tv/users/1coolguy/lists/anime-tv-shows/items', 'icon.png', 'icon.png')
        self.addDirectoryItem('Anime Movies', 'movies&url=https://api.trakt.tv/users/mokins/lists/anime-movies/items', 'icon.png', 'icon.png')
        self.addDirectoryItem('Marvel Animated Cartoons', 'tvshows&url=https://api.trakt.tv/users/1coolguy/lists/marvel-animated-tv-shows/items', 'marvel animated shows.png', 'marvel animated shows.png')
        self.addDirectoryItem('Marvel Animated Movies', 'movies&url=https://api.trakt.tv/users/1coolguy/lists/marvel-animated-movies/items', 'marvel-animated movies.png', 'marvel-animated movies.png')
        self.addDirectoryItem('Nickelodeon', 'tvshows&url=https://api.trakt.tv/users/a925sw/lists/all-nickelodeon-shows/items', 'nickelodeon.png', 'nickelodeon.png')
        self.addDirectoryItem('DC Animated Movies', 'movies&url=https://api.trakt.tv/users/1coolguy/lists/dc-animated-movies/items', 'dcanimatedmovies.png', 'dcanimatedmovies.png')
        self.addDirectoryItem('DC Animated Tv Shows', 'tvshows&url=https://api.trakt.tv/users/1coolguy/lists/dc-animated-cartoons/items', 'dccartoons.png', 'dccartoons.png')
        self.endDirectory()
        
    def docs(self):
        self.addDirectoryItem('Crime Docs', 'movies&url=https://www.imdb.com/list/ls093689139/?sort=release_date,desc&st_dt=&mode=detail&page=1', 'documentaries.png', 'documentaries.png')
        self.addDirectoryItem('All Around Docs', 'movies&url=https://api.trakt.tv/users/movistapp/lists/documentary/items', 'documentaries.png', 'documentaries.png')
        self.addDirectoryItem('Celebrities&Drugs', 'movies&url=https://api.trakt.tv/users/by-ahj/lists/documentary/items', 'documentaries.png', 'documentaries.png')
        self.addDirectoryItem('Music Docs', 'movies&url=https://api.trakt.tv/users/1coolguy/lists/music-docs/items', 'documentaries.png', 'documentaries.png')
        self.addDirectoryItem('Horror Docs', 'movies&url=https://api.trakt.tv/users/istoit/lists/horror-docs/items', 'documentaries.png', 'documentaries.png')
        self.addDirectoryItem('Food Docs', 'movies&url=https://api.trakt.tv/users/1coolguy/lists/food-docs/items', 'documentaries.png', 'documentaries.png')
        self.addDirectoryItem('War Docs', 'movies&url=https://www.imdb.com/list/ls038497695/?sort=release_date,desc&st_dt=&mode=detail&page=1', 'documentaries.png', 'documentaries.png')
        self.addDirectoryItem('Sports Docs', 'movies&url=https://api.trakt.tv/users/1coolguy/lists/sports-docs/items', 'documentaries.png', 'documentaries.png')
        self.endDirectory()
        
    def fitness(self):
        self.addDirectoryItem('Fitness', 'lists6', 'fitness.png', 'fitness.png')
        self.endDirectory()
    ...
    def tools(self):
        self.addDirectoryItem('[B]DG[/B] : Changelog', 'changelog', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
        ...
        self.addDirectoryItem(32079, 'encrypticscrapersettings', 'icon.png', 'DefaultAddonProgram.png', isFolder=False)
