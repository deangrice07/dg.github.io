...
class sources:
    ...
    def sourcesProcessTorrents(self, torrent_sources):#adjusted Nightwing code
    ...
    def getConstants(self):
        ...
        oas_module_name = 'DGScrapers (' + str(control.addon('script.module.dgscrapers').getSetting('package.folder')) + ' set):' \
                          if control.addon('script.module.dgscrapers').getSetting('package.folder') != 'DGScrapers' else 'DGScrapers:'
        ...
        try:
            if scraperSetting == 'DG Scrapers':
                self.sourceDict = sourceDir1
                self.module_name = oas_module_name
            elif scraperSetting == 'DG Scrapers':
                ...
                self.sourceDict = sourceDir1
                self.module_name = oas_module_name
                control.setSetting('module.provider', 'DG Scrapers')
        except:
            return
