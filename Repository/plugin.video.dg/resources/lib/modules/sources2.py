...
class sources:
    ...
    def getConstants(self):
        ...
        try:
            if xbmc.getCondVisibility('System.HasAddon(%s)' % 'script.module.openscrapers') and not scraperSetting == 'Liptonmodule':
                ...
                self.sourceDict = sources()
                self.module_name = 'Liptonmodule'
                control.setSetting('module.provider', 'Liptonmodule')
        except: return
