...
from liptonscrapers.modules import client, cleantitle, directstream, dom_parser2
...
class source:
    def __init__(self):
        self.priority = 1
        self.language = ['en']
        self.domains = ['l23movies.com', '123moviesc.co']
        self.base_link = 'https://www.123moviesc.co'
