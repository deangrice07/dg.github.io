...
#    #######    ##       ##     .      ###      #########   ##     ##    #########   ##########  ##      #   ##     ##   ##          ########   ##      #   ##########     #
############################################################################################################################################################################
# Testing @Cy4Root 01-10-2019 movie: It Chapter one

import re,urlparse,urllib,base64
from liptonscrapers.modules import cleantitle,client,dom_parser2,cfscrape
...
class source:
    def __init__(self):
        ...
        self.base_link = 'http://www1.movies1234.net', 'movies123.xyz', 'movies123.ac/'
