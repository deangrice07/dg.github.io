...
from liptonscrapers.modules import client2 as client
from liptonscrapers.modules import dom_parser2 as dom
from liptonscrapers.modules import cleantitle2 as cleantitle
from liptonscrapers.modules import debrid, source_utils, workers


class source:
    def __init__(self):
        self.priority = 1
        self.language = ['en', 'de', 'nl', 'fr', 'ko', 'pl', 'pt', 'ru']
