...
lang = xbmcaddon.Addon("script.module.liptonscrapers").getLocalizedString

lang2 = xbmc.getLocalizedString

setting = xbmcaddon.Addon("script.module.liptonscrapers").getSetting

setSetting = xbmcaddon.Addon("script.module.liptonscrapers").setSetting
...
addonInfo = xbmcaddon.Addon("script.module.liptonscrapers").getAddonInfo
...
def getExternalSetting(addonID, addonSetting):
    return xbmcaddon.Addon(addonID).getSetting(addonSetting)
