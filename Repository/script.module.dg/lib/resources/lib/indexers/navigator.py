...
class navigator:
    ...
    NEWSFILE      = base64.b64decode(b'aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L1FTcFBOUzdK')
...
#            self.addDirectoryItem('You Tube Videos', 'youtube', 'youtube.png', 'youtube.png')
        ...
        if self.getMenuEnabled('navi.sports') == True:
            self.addDirectoryItem('Sports Area', 'sports', 'iptv.png', 'iptv.png')
        ...
        if self.getMenuEnabled('navi.kids') == True:
            self.addDirectoryItem('Kids Area', 'kidsNavigator', 'cartoons.png', 'DefaultTVShows.png')
        ...
        if porn == True:
            self.addDirectoryItem('[B][COLOR pink]Adult 18+[/COLOR][/B]', 'porn', 'tvshows.png', 'DefaultTVShows.png')
        ...
        test = True if control.setting('t') == 'test' else False
        if test == True:
            self.addDirectoryItem('TestStuff', 'test', 'tvshows.png', 'DefaultTVShows.png')
...
#######################################################################
    def kids(self):
        self.addDirectoryItem('Animation', 'movies&url=https://api.trakt.tv/users/giladg/lists/animation/items', 'pbskids.png', 'DefaultMovies.png')
        self.addDirectoryItem('Top 350 Cartoons of All-Time', 'tvshows&url=cartoons', 'pbskids.png', 'cartoons.png')
        self.addDirectoryItem('Nickelodeon', 'tvshows&url=nic', 'pbskids.png', 'kids.png')
        self.addDirectoryItem('Cartoon Network', 'tvshows&url=cn', 'pbskids.png', 'kids.png')
        self.addDirectoryItem('Disney', 'tvshows&url=dis', 'pbskids.png', 'kids.png')
        self.addDirectoryItem('One Click Kids Movies', 'onekids', 'pbskids.png', 'kids.png')
        self.endDirectory()
...
#        self.addDirectoryItem('[B][COLOR yellow]24/7 Movies[/COLOR][/B]', '247movies', 'movies.png', 'DefaultMovies.png')
        ...
        self.addDirectoryItem('1 Click Movies (Real-Debrid Needed) Link 2 is working', '1click', 'featured.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('1 Click Stuff', '1clickcollections', 'featured.png', 'DefaultRecentlyAddedMovies.png')
