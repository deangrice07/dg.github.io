...
class navigator:
    ...
    def root(self):
        ...
        if self.getMenuEnabled('navi.sports') == True:
            self.addDirectoryItem(90006, 'bluehat', 'sports_schannels.png', 'DefaultMovies.png')
        if self.getMenuEnabled('navi.iptv') == True:
            self.addDirectoryItem(90007, 'whitehat', 'iptv.png', 'DefaultMovies.png')
        if self.getMenuEnabled('navi.kidsgrey') == True:
            self.addDirectoryItem(90009, 'kidsgreyNavigator', 'kids_trending.png', 'DefaultTVShows.png')
        if self.getMenuEnabled('navi.1clicks') == True:
            self.addDirectoryItem(90011, 'greenhat', 'eyecandy.png', 'DefaultMovies.png')
        if self.getMenuEnabled('navi.purplehat') == True:
            self.addDirectoryItem(90189, 'purplehat', 'collections.png', 'DefaultMovies.png')
        if self.getMenuEnabled('navi.slim') == False:
            if self.getMenuEnabled('navi.standup') == True:
                self.addDirectoryItem(90113, 'redhat', 'standup.png', 'DefaultMovies.png')
        if self.getMenuEnabled('navi.slim') == False:
        ...
        if self.getMenuEnabled('navi.slim') == False:
            if self.getMenuEnabled('navi.radio') == False:
                self.addDirectoryItem(90012, 'yellowhat','radio.png', 'radio.png')
        if self.getMenuEnabled('navi.slim') == False:
            if self.getMenuEnabled('navi.add_addons') == False:
