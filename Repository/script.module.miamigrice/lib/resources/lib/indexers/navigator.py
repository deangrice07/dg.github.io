...
class navigator:
    ...
    def root(self):
        ...
        if self.getMenuEnabled('navi.monthlyspotlight') == True:
            self.addDirectoryItem('[COLORghostwhite]WELCOME TO[/COLOR] [COLORcyan]M[/COLOR][COLORfuchsia]I[/COLOR][COLORcyan]A[/COLOR][COLORfuchsia]M[/COLOR][COLORcyan]I[/COLOR] [COLORfuchsia]G[/COLOR][COLORcyan]R[/COLOR][COLORfuchsia]I[/COLOR][COLORcyan]C[/COLOR][COLORfuchsia]E[/COLOR]', 'movies&url=spotlight', 'icon.gif', 'DefaultRecentlyAddedMovies.png')
        
        if self.getMenuEnabled('navi.sports') == True:
            self.addDirectoryItem('Sports Area', 'sports', 'sports.gif', 'sports.png')
        
        if self.getMenuEnabled('navi.iptv') == True:
            self.addDirectoryItem('IPTV Area', 'iptvNavigator', 'iptv.gif', 'iptv.png')
        ...
        if self.getMenuEnabled('navi.docu') == True:
            self.addDirectoryItem(32631, 'docNav', 'docs.gif', 'DefaultMovies.png')

        if self.getMenuEnabled('navi.kids') == True:
            self.addDirectoryItem('Kids Area', 'kidsNavigator', 'kids.gif', 'kids.png')
       
        if self.getMenuEnabled('navi.yt') == True:
            self.addDirectoryItem('You Tube Videos', 'youtube', 'youtube.gif', 'youtube.png')

        if not control.setting('lists.widget') == '0':
            self.addDirectoryItem(32003, 'mymovieNavigator', 'mymovies.gif', 'DefaultVideoPlaylists.png')
            self.addDirectoryItem(32004, 'mytvNavigator', 'mytvshows.gif', 'DefaultVideoPlaylists.png')
        ...
        if not control.setting('furk.api') == '':
            self.addDirectoryItem('Furk.net', 'furkNavigator', 'movies.gif', 'movies.png')

        self.addDirectoryItem(32010, 'searchNavigator', 'search.gif', 'DefaultAddonProgram.png')
    ...
    def furk(self):
        ...
        self.addDirectoryItem('Search', 'furkSearch', 'search.gif', 'search.png')
        self.endDirectory()
...
#######################################################################
    ...
    def iptv(self):
        self.addDirectoryItem('USA Channels', 'iptv_usa', 'iptv.gif', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('UK Channels', 'iptv_uk', 'iptv.gif', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('WORLD Channels', 'iptv_world', 'iptv.gif', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('CCTV', 'iptv_cctv', 'iptv.gif', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(32007, 'channels', 'channels.png', 'DefaultMovies.png')
        self.addDirectoryItem('Swift Streams', 'swiftNavigator', 'iptv.gif', 'iptv.png')
    ...
    def movies(self, lite=False):
        self.addDirectoryItem('[COLORcyan]M[/COLOR][COLORfuschia]I[/COLOR][COLORcyan]A[/COLOR][COLORfuschia]M[/COLOR][COLORcyan]I[/COLOR] [COLORfuschia]G[/COLOR][COLORcyan]R[/COLOR][COLORfuschia]I[/COLOR][COLORcyan]C[/COLOR][COLORfuschia]E[/COLOR] Favourites', 'movies&url=it', 'featured.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('Movies Lists', 'traktNav', 'trakt.gif', 'DefaultMovies.png')
        self.addDirectoryItem(32000, 'collectionsNavigator', 'boxsets.png', 'DefaultMovies.png')
        self.addDirectoryItem('24/7 Movies', '247movies', 'movies.png', 'DefaultMovies.png')
    ...
    def mymovies(self, lite=False):
        ...
        if traktIndicators == True:
            self.addDirectoryItem(32036, 'movies&url=trakthistory', 'trakt.getTraktIndicatorsInfo', 'DefaultMovies.png', queue=True)
    ...
    def tools(self):
        ...
        self.addDirectoryItem(32044, 'openSettings&query=7.1', 'tools.gif', 'DefaultAddonProgram.png')
        ...
        self.addDirectoryItem(32046, 'openSettings&query=10.0', 'tools.gif', 'DefaultAddonProgram.png')
        self.addDirectoryItem(32047, 'openSettings&query=4.0', 'tools.gif', 'DefaultAddonProgram.png')
        self.addDirectoryItem(32556, 'libraryNavigator', 'tools.gif', 'DefaultAddonProgram.png')
        self.addDirectoryItem(32048, 'openSettings&query=9.0', 'tools.gif', 'DefaultAddonProgram.png')
        self.addDirectoryItem(32049, 'viewsNavigator', 'tools.gif', 'DefaultAddonProgram.png')
        self.addDirectoryItem('Cache Functions', 'cfNavigator', 'tools.gif', 'DefaultAddonProgram.png')
        self.addDirectoryItem(32073, 'authTrakt', 'trakt.gif', 'DefaultAddonProgram.png')
        self.addDirectoryItem(32609, 'urlResolver', 'resolveurl.gif', 'DefaultAddonProgram.png')
        self.endDirectory()
