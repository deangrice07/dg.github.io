...
def _find_cache_version():
    ...
    try:
        ...
        import xbmc
        print 'it Addon Data Path Does not Exist. Creating Folder....'
        ad_folder = xbmc.translatePath('special://home/userdata/addon_data/plugin.video.miamigrice')
    ...
    try:
        curVersion = control.addon('script.module.miamigrice').getAddonInfo('version')
