...
class navigator:
    def root(self):
        # self.addDirectoryItem('[COLOR=yellow][B]FSM Has Own Resolver, Auth In Tools[/B][/COLOR]', 'nonewsNavigator', 'userlists.png', 'DefaultAddonProgram.png')
#         self.addDirectoryItem('[COLOR=yellow][B]Set 1080p or 4K | Set AutoPlay on/of[/B][/COLOR]', 'nonewsNavigator', 'userlists.png', 'DefaultAddonProgram.png')
#         self.addDirectoryItem('[COLOR=yellow][B]Set Max File Size -> Tools -> Setting[/B][/COLOR]', 'nonewsNavigator', 'userlists.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem(32001, 'movieNavigator', 'movies.png', 'DefaultMovies.png')
        self.addDirectoryItem(32002, 'tvNavigator', 'tvshows.png', 'DefaultTVShows.png')
        #self.addDirectoryItem('Lists', 'xmlsNavigator', 'icon.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Dedrid 1 Click Movies', 'lists1', 'icon.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Free 1 Click Movies', 'lists2', 'icon.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Free 1 Click Youtube', 'lists3', 'icon.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Dust Sci-Fi', 'lists4', 'icon.png', 'DefaultTVShows.png')
    ...
    def xmls(self):
        self.addDirectoryItem('Diamond 1 Click List', 'extinfo', 'icon.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Loonatics 1 Click List', 'lists1', 'icon.png', 'DefaultTVShows.png')
        #self.addDirectoryItem('Wolfgirl', 'wolfNavigator', 'icon.png', 'DefaultTVShows.png')
        #self.addDirectoryItem('Free One Clicks Grab Bag 3', 'lists2', 'icon.png', 'DefaultTVShows.png')
        #self.addDirectoryItem('Free One Clicks Grab Bag 4', 'lists3', 'icon.png', 'DefaultTVShows.png')
        #self.addDirectoryItem('Free One Clicks Grab Bag 5', 'lists4', 'icon.png', 'DefaultTVShows.png')
    ...
    def tools(self):
        ...
        self.addDirectoryItem(32079, 'dgscrapersettings', 'icon.png', 'DefaultAddonProgram.png', isFolder=False)
        ...
        self.addDirectoryItem(32076, 'smuSettings', 'diamondresolve.png', 'DefaultAddonProgram.png', isFolder=False)
