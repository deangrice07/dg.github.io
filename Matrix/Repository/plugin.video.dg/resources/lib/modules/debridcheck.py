...
##-- FSM add-on's debrid cache check module adjusted for FSM/FSM code base - all credits to FSM --##
...
__r_url__ = control.addon('script.module.diamondresolve')
...
class DLapi:
    def __init__(self):
        ...
        self.user_agent = 'DiamondResolve for Kodi/{0}'.format(__r_url__.getAddonInfo('version'))
