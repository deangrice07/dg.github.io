...
class UpToBoxResolver(DiamondResolve):
    name = "uptobox"
    ...
    def get_settings_xml(cls):
        ...
        xml.append('<setting id="{0}_auth" type="action" label="{1}" action="RunPlugin(plugin://script.module.diamondresolve/?mode=auth_ub)"/>'.format(cls.__name__, i18n('auth_my_account')))
        xml.append('<setting id="{0}_reset" type="action" label="{1}" action="RunPlugin(plugin://script.module.diamondresolve/?mode=reset_ub)"/>'.format(cls.__name__, i18n('reset_my_auth')))
