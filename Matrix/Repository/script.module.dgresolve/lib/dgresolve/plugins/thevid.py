...
import diamondresolve.plugins.thevid_gmu
from diamondresolve import common
from diamondresolve.resolver import DiamondResolve, ResolverError

logger = common.log_utils.Logger.get_logger(__name__)
logger.disable()
VID_SOURCE = r'https://raw.githubusercontent.com/jsergio123/script.module.diamondresolve/master/lib/diamondresolve/plugins/thevid_gmu.py'

VID_PATH = os.path.join(common.plugins_path, 'thevid_gmu.py')


class TheVidResolver(DiamondResolve):
    name = "TheVid"
    ...
    def get_media_url(self, host, media_id):
        try:
            ...
            reload_module(diamondresolve.plugins.thevid_gmu)
            web_url = self.get_url(host, media_id)
            return diamondresolve.plugins.thevid_gmu.get_media_url(web_url)
