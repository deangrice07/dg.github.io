...
from dgresolve.lib.net import Net, get_ua  # @UnusedImport  # NOQA
from dgresolve.lib import cache  # @UnusedImport  # NOQA
from dgresolve.lib import kodi
from dgresolve.lib import pyaes
from random import choice

logger = log_utils.Logger.get_logger()
addon_path = kodi.get_path()
plugins_path = os.path.join(addon_path, 'lib', 'dgresolve', 'plugins')
...
SMR_USER_AGENT = 'DGResolve for Kodi/%s' % (addon_version)
