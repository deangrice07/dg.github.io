...
import sys
from dgresolve.lib import kodi
from dgresolve.lib import log_utils
from dgresolve.lib import cache
from dgresolve.lib.url_dispatcher import URL_Dispatcher
...
def auth_pm():
    ...
    from dgresolve.plugins import premiumize_me
...
def auth_rd():
    kodi.close_all()
    kodi.sleep(500)  # sleep or authorize won't work for some reason
    from dgresolve.plugins import realdebrid
...
def auth_ad():
    kodi.close_all()
    kodi.sleep(500)  # sleep or authorize won't work for some reason
    from dgresolve.plugins import alldebrid
...
def auth_ub():
    kodi.close_all()
    kodi.sleep(500)  # sleep or authorize won't work for some reason
    from dgresolve.plugins import uptobox
...
def auth_ls():
    kodi.close_all()
    kodi.sleep(500)  # sleep or authorize won't work for some reason
    from dgresolve.plugins import linksnappy
...
def auth_dl():
    kodi.close_all()
    kodi.sleep(500)  # sleep or authorize won't work for some reason
    from dgresolve.plugins import debrid_link
