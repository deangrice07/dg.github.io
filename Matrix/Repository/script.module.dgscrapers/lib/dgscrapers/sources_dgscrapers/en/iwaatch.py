...
# Addon Name: Diamond Build
# Addon id: plugin.video.fsmforkyou
# Addon Provider: Diamond Build
...
from fsmforkyouscrapers.modules import cleantitle, client, source_utils, log_utils
