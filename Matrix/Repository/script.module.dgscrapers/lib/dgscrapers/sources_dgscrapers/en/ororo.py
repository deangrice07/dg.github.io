...
from revolutionscrapers.modules import control
...
class source:
    def __init__(self):
        ...
        self.user = control.addon('plugin.video.revolution').getSetting('ororo.user')
        self.password = control.addon('plugin.video.revolution').getSetting('ororo.pass')
        self.headers = {
